...
const uint rgbPin[3] = {13, 12, 11}; // Red=13, Blue=12, Green=11
const uint reset_pin = 22;           // Butão do joystick
...
// Função de callback para desligar o LED verde após 6 segundos.
int64_t turn_off_Blue(alarm_id_t id, void *user_data)
{
    // Desliga o LED configurando o pino 12 para nível baixo.
...
int64_t turn_off_Red(alarm_id_t id, void *user_data)
{
    // Desliga o LED configurando o pino 13 para nível baixo.
